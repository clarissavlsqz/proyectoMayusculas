...
class ViewControllerMainRules: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = "\(indexPath.row + 1). \(normas[indexPath.row].nombre)"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        viewNorma.titleNorma = normas[indice.row].nombre
        viewNorma.norma = normas[indice.row].descripcion
    }
